    ...
    <Form noValidate>
      ...
      <Form.Group as={Row} controlId="travellersEmail" className="mb-5">
        ...
        <Col sm="9">
          ...
          <Form.Control.Feedback type="invalid" role="alert">
            <span className="sr-only">
              {props.travellersEmail.length < 1
                ? props.messages.email_form_field_required
                : props.messages.email_form_field_invalid}
              .{" "}
            </span>
            {props.travellersEmail.length < 1
              ? props.messages.email_form_field_required
      ...
      <Form.Group as={Row} controlId="tripName">
        <Form.Label column sm="3">
          ...
          <small className="row pl-3">({props.messages.required})</small>
          <span className="sr-only">
            {props.messages.email_form_trip_name_placeholder}
          </span>
          <span className="sr-only">
      ...
      <Form.Group as={Row} controlId="travelCategory">
        <Form.Label column sm="3">
          <span className="row pl-3">
            {props.messages.email_form_category_label}
          </span>
          <small className="row pl-3">({props.messages.required})</small>
        </Form.Label>
        <Col sm="9">
