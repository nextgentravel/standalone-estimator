...
const Header = ({ homeHeader }) => {
  ...
  let messages = allPrismicStandaloneestimatorHomepage.nodes.find(function (o) {
          ...
          <div className="row my-3 mx-2">
            ...
            <section className="text-right align-self-center ml-auto">
              <h2 className="sr-only sr-only-focusable aurora-skip">
                {messages.header_language_select}
              </h2>
              <SelectLanguage />
            </section>
          </div>
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <a href={messages.breadcrumb_home_link}>
                  {messages.breadcrumb_home_text}
                </a>
              </li>
