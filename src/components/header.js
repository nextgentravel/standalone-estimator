...
const Header = ({homeHeader}) => {
  ...
  let headerHtml = `
    <div id="wb-bnr" class="wet-container">
      ...
      <nav role="navigation" id="wb-sm" data-ajax-replace="/site/html5/includes/sitemenu-eng.html"
  ...
  return (
    ...
    <header role="banner" className="wet-body" dangerouslySetInnerHTML={{__html: headerHtml}}>
